  ...
  <div class="modal-win" style="width: 580px; max-height: 500px;">
    ...
    <div class="modal-body" style="padding: 24px; background: #1e1e1e">
      ...
      <div class="setting-group" style="display: flex; align-items: center; margin-bottom: 16px;">
        <label style="width: 140px; color: #ccc; font-size: 13px;">Color Theme:</label>
        <select id="set-theme-name" style="flex: 1; padding: 6px 12px; background: #2d2d2d; border: 1px solid #3c3c3c; border-radius: 4px; color: #fff; outline: none;">
          <option value="abyss">Abyss</option>
          <option value="dark-vs">Dark (Visual Studio)</option>
          <option value="dark-2026">Dark 2026 (default)</option>
          ...
          <option value="light-vs">Visual Studio Light</option>
          <option value="light-2026">Light 2026</option>
          <option value="light-hc">Default High Contrast Light</option>
