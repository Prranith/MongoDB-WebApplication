...
:root {
  ...
  --bg2:        #18181f; /* Soft light-black explorer bg */
  ...
  <div id="workspace">
    ...
    <div id="ide-panel" style="display:none;flex-direction:column;flex:1;overflow:hidden">
      ...
      <div id="console">
        ...
        <div id="console-header" style="height: 35px; background: var(--bg); border-bottom: 1px solid var(--border); display: flex; align-items: center; padding: 0 12px; gap: 12px; flex-shrink: 0;">
